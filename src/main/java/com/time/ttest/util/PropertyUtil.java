...
import com.time.ttest.TTestProperties;
...
public class PropertyUtil {
    ...
    public static Properties loadFile(String fileName, Class<?> clazz)  {
    ...
    private static Properties initYml(InputStream inputStream) {
        Yaml yaml = new Yaml();
    ...
    public static Properties getPropertyPrefix(Properties properties, String prefix,String addPrefix){
