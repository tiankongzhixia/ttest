 ...
 */
public class TEqualsAssert implements Assert{

    @Override
    public void tassert(TTestAssert tTestAssert, Object actual, Object expect) {
        if (tTestAssert.getAssertTypeEnum() != TAssertType.Equals) return;
        ...
        if (actual instanceof List){
            ...
            org.testng.Assert.assertEquals(String.valueOf(actual),String.valueOf(expect),tTestAssert.getErrorMsg());
        }
    }
}
